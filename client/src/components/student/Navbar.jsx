...
const Navbar = () => {
    ...
    const {user} = useUser()
    return(
      <div className={`flex item-center justify-between px-4 sm:px-10 md:px-14 lg:px-36 border-b border-grey-500 py-4 bg ${isCourseListPage?'bg-white':'bg-cyan-100/70'}`}>
        
        <img src={assets.logo} alt="Logo" className="w-28 lg:2-32 cursorgit-pointer" />
